# Comparing `tmp/symbolic-learn-0.1.0.tar.gz` & `tmp/symbolic-learn-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "symbolic-learn-0.1.0.tar", last modified: Fri Apr 14 14:38:23 2023, max compression
+gzip compressed data, was "symbolic-learn-0.1.1.tar", last modified: Fri Apr 14 14:44:22 2023, max compression
```

## Comparing `symbolic-learn-0.1.0.tar` & `symbolic-learn-0.1.1.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxrwxr-x   0 vincent   (1000) vincent   (1000)        0 2023-04-14 14:38:23.582050 symbolic-learn-0.1.0/
--rw-rw-r--   0 vincent   (1000) vincent   (1000)     1072 2023-04-13 10:14:20.000000 symbolic-learn-0.1.0/LICENSE.txt
--rw-rw-r--   0 vincent   (1000) vincent   (1000)     2325 2023-04-14 14:38:23.582050 symbolic-learn-0.1.0/PKG-INFO
--rw-rw-r--   0 vincent   (1000) vincent   (1000)     1751 2023-04-14 13:42:40.000000 symbolic-learn-0.1.0/README.rst
--rw-rw-r--   0 vincent   (1000) vincent   (1000)      783 2023-04-14 14:34:25.000000 symbolic-learn-0.1.0/pyproject.toml
-drwxrwxr-x   0 vincent   (1000) vincent   (1000)        0 2023-04-14 14:38:23.582050 symbolic-learn-0.1.0/sblearn/
--rw-rw-r--   0 vincent   (1000) vincent   (1000)        0 2023-03-17 10:13:18.000000 symbolic-learn-0.1.0/sblearn/__init__.py
--rw-rw-r--   0 vincent   (1000) vincent   (1000)   348239 2023-04-14 13:33:26.000000 symbolic-learn-0.1.0/sblearn/compute.c
--rw-rw-r--   0 vincent   (1000) vincent   (1000)    15924 2023-04-14 14:17:57.000000 symbolic-learn-0.1.0/sblearn/models.py
--rw-rw-r--   0 vincent   (1000) vincent   (1000)   855277 2023-04-14 13:33:26.000000 symbolic-learn-0.1.0/sblearn/trees.c
--rw-rw-r--   0 vincent   (1000) vincent   (1000)       38 2023-04-14 14:38:23.582050 symbolic-learn-0.1.0/setup.cfg
--rw-rw-r--   0 vincent   (1000) vincent   (1000)     1401 2023-04-14 14:11:48.000000 symbolic-learn-0.1.0/setup.py
-drwxrwxr-x   0 vincent   (1000) vincent   (1000)        0 2023-04-14 14:38:23.582050 symbolic-learn-0.1.0/symbolic_learn.egg-info/
--rw-rw-r--   0 vincent   (1000) vincent   (1000)     2325 2023-04-14 14:38:23.000000 symbolic-learn-0.1.0/symbolic_learn.egg-info/PKG-INFO
--rw-rw-r--   0 vincent   (1000) vincent   (1000)      307 2023-04-14 14:38:23.000000 symbolic-learn-0.1.0/symbolic_learn.egg-info/SOURCES.txt
--rw-rw-r--   0 vincent   (1000) vincent   (1000)        1 2023-04-14 14:38:23.000000 symbolic-learn-0.1.0/symbolic_learn.egg-info/dependency_links.txt
--rw-rw-r--   0 vincent   (1000) vincent   (1000)       57 2023-04-14 14:38:23.000000 symbolic-learn-0.1.0/symbolic_learn.egg-info/requires.txt
--rw-rw-r--   0 vincent   (1000) vincent   (1000)        8 2023-04-14 14:38:23.000000 symbolic-learn-0.1.0/symbolic_learn.egg-info/top_level.txt
...
### Comparing `symbolic-learn-0.1.0/LICENSE.txt` & `symbolic-learn-0.1.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `symbolic-learn-0.1.0/PKG-INFO` & `symbolic-learn-0.1.1/PKG-INFO`
...
### Comparing `symbolic-learn-0.1.0/README.rst` & `symbolic-learn-0.1.1/README.rst`
...
### Comparing `symbolic-learn-0.1.0/pyproject.toml` & `symbolic-learn-0.1.1/pyproject.toml`
...
### Comparing `symbolic-learn-0.1.0/sblearn/compute.c` & `symbolic-learn-0.1.1/sblearn/compute.c`

 * *Files identical despite different names*

### Comparing `symbolic-learn-0.1.0/sblearn/models.py` & `symbolic-learn-0.1.1/sblearn/models.py`

 * *Files identical despite different names*

### Comparing `symbolic-learn-0.1.0/sblearn/trees.c` & `symbolic-learn-0.1.1/sblearn/trees.c`

 * *Files identical despite different names*

### Comparing `symbolic-learn-0.1.0/setup.py` & `symbolic-learn-0.1.1/setup.py`

 * *Files identical despite different names*

### Comparing `symbolic-learn-0.1.0/symbolic_learn.egg-info/PKG-INFO` & `symbolic-learn-0.1.1/symbolic_learn.egg-info/PKG-INFO`
