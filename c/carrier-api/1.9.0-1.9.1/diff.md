# Comparing `tmp/carrier_api-1.9.0.tar.gz` & `tmp/carrier_api-1.9.1.tar.gz`
...
+gzip compressed data, was "carrier_api-1.9.1.tar", last modified: Fri Apr 14 03:18:28 2023, max compression
```

## Comparing `carrier_api-1.9.0.tar` & `carrier_api-1.9.1.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-14 03:18:28.763010 carrier_api-1.9.1/
+-rwxr-xr-x   0 runner    (1001) docker     (123)     1066 2023-04-14 03:17:57.000000 carrier_api-1.9.1/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     2056 2023-04-14 03:18:28.763010 carrier_api-1.9.1/PKG-INFO
+-rwxr-xr-x   0 runner    (1001) docker     (123)     1350 2023-04-14 03:17:57.000000 carrier_api-1.9.1/README.md
+-rwxr-xr-x   0 runner    (1001) docker     (123)      104 2023-04-14 03:17:57.000000 carrier_api-1.9.1/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-14 03:18:28.763010 carrier_api-1.9.1/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)     1231 2023-04-14 03:18:18.000000 carrier_api-1.9.1/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-14 03:18:28.759009 carrier_api-1.9.1/src/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-14 03:18:28.759009 carrier_api-1.9.1/src/carrier_api/
+-rwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     6617 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/api_connection.py
+-rw-r--r--   0 runner    (1001) docker     (123)     6695 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/config.py
+-rwxr-xr-x   0 runner    (1001) docker     (123)      616 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/const.py
+-rwxr-xr-x   0 runner    (1001) docker     (123)      151 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/errors.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2222 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/profile.py
+-rw-r--r--   0 runner    (1001) docker     (123)     5020 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/status.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1819 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/stub.py
+-rw-r--r--   0 runner    (1001) docker     (123)      803 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/system.py
+-rw-r--r--   0 runner    (1001) docker     (123)      555 2023-04-14 03:17:57.000000 carrier_api-1.9.1/src/carrier_api/util.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-14 03:18:28.763010 carrier_api-1.9.1/src/carrier_api.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     2056 2023-04-14 03:18:28.000000 carrier_api-1.9.1/src/carrier_api.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      501 2023-04-14 03:18:28.000000 carrier_api-1.9.1/src/carrier_api.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-14 03:18:28.000000 carrier_api-1.9.1/src/carrier_api.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       53 2023-04-14 03:18:28.000000 carrier_api-1.9.1/src/carrier_api.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       12 2023-04-14 03:18:28.000000 carrier_api-1.9.1/src/carrier_api.egg-info/top_level.txt
```

### Comparing `carrier_api-1.9.0/LICENSE` & `carrier_api-1.9.1/LICENSE`

 * *Files identical despite different names*

### Comparing `carrier_api-1.9.0/setup.py` & `carrier_api-1.9.1/setup.py`
...
### Comparing `carrier_api-1.9.0/src/carrier_api/api_connection.py` & `carrier_api-1.9.1/src/carrier_api/api_connection.py`
...
### Comparing `carrier_api-1.9.0/src/carrier_api/config.py` & `carrier_api-1.9.1/src/carrier_api/config.py`
...
### Comparing `carrier_api-1.9.0/src/carrier_api/const.py` & `carrier_api-1.9.1/src/carrier_api/const.py`

 * *Files identical despite different names*

### Comparing `carrier_api-1.9.0/src/carrier_api/profile.py` & `carrier_api-1.9.1/src/carrier_api/profile.py`
...
### Comparing `carrier_api-1.9.0/src/carrier_api/status.py` & `carrier_api-1.9.1/src/carrier_api/status.py`
...
### Comparing `carrier_api-1.9.0/src/carrier_api/stub.py` & `carrier_api-1.9.1/src/carrier_api/stub.py`

 * *Files identical despite different names*

### Comparing `carrier_api-1.9.0/src/carrier_api/system.py` & `carrier_api-1.9.1/src/carrier_api/system.py`

 * *Files identical despite different names*

### Comparing `carrier_api-1.9.0/src/carrier_api/util.py` & `carrier_api-1.9.1/src/carrier_api/util.py`
