# Comparing `tmp/bluepyefe-2.2.47.tar.gz` & `tmp/bluepyefe-2.2.48.tar.gz`
...
### Comparing `bluepyefe-2.2.47/bluepyefe/recording.py` & `bluepyefe-2.2.48/bluepyefe/recording.py`
