# Comparing `tmp/pyprocessors-afp_sports-0.5.32.tar.gz` & `tmp/pyprocessors-afp_sports-0.5.8.tar.gz`
...
### Comparing `pyprocessors-afp_sports-0.5.32/PKG-INFO` & `pyprocessors-afp_sports-0.5.8/PKG-INFO`
