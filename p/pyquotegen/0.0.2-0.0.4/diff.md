# Comparing `tmp/pyquotegen-0.0.2.tar.gz` & `tmp/pyquotegen-0.0.4.tar.gz`
...
+gzip compressed data, was "pyquotegen-0.0.4.tar", last modified: Fri Apr 14 12:31:28 2023, max compression
```

## Comparing `pyquotegen-0.0.2.tar` & `pyquotegen-0.0.4.tar`
...
+drwxr-xr-x   0 runner    (1000) runner    (1000)        0 2023-04-14 12:31:28.815255 pyquotegen-0.0.4/
+-rw-r--r--   0 runner    (1000) runner    (1000)     1068 2023-04-01 05:29:52.000000 pyquotegen-0.0.4/LICENSE
+-rw-r--r--   0 runner    (1000) runner    (1000)     2372 2023-04-14 12:31:28.811255 pyquotegen-0.0.4/PKG-INFO
+-rw-r--r--   0 runner    (1000) runner    (1000)     1575 2023-04-14 12:27:07.000000 pyquotegen-0.0.4/README.md
+drwxr-xr-x   0 runner    (1000) runner    (1000)        0 2023-04-14 12:31:28.811255 pyquotegen-0.0.4/pyquotegen/
+-rw-r--r--   0 runner    (1000) runner    (1000)      686 2023-04-01 06:25:39.000000 pyquotegen-0.0.4/pyquotegen/__init__.py
+-rw-r--r--   0 runner    (1000) runner    (1000)    19158 2023-04-01 05:29:52.000000 pyquotegen-0.0.4/pyquotegen/all_quotes.py
+drwxr-xr-x   0 runner    (1000) runner    (1000)        0 2023-04-14 12:31:28.811255 pyquotegen-0.0.4/pyquotegen.egg-info/
+-rw-r--r--   0 runner    (1000) runner    (1000)     2372 2023-04-14 12:31:28.000000 pyquotegen-0.0.4/pyquotegen.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1000) runner    (1000)      210 2023-04-14 12:31:28.000000 pyquotegen-0.0.4/pyquotegen.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1000) runner    (1000)        1 2023-04-14 12:31:28.000000 pyquotegen-0.0.4/pyquotegen.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1000) runner    (1000)       11 2023-04-14 12:31:28.000000 pyquotegen-0.0.4/pyquotegen.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1000) runner    (1000)       38 2023-04-14 12:31:28.815255 pyquotegen-0.0.4/setup.cfg
+-rw-r--r--   0 runner    (1000) runner    (1000)     1192 2023-04-14 12:31:20.000000 pyquotegen-0.0.4/setup.py
```

### Comparing `pyquotegen-0.0.2/LICENSE` & `pyquotegen-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `pyquotegen-0.0.2/pyquotegen/__init__.py` & `pyquotegen-0.0.4/pyquotegen/__init__.py`

 * *Files identical despite different names*

### Comparing `pyquotegen-0.0.2/pyquotegen/all_quotes.py` & `pyquotegen-0.0.4/pyquotegen/all_quotes.py`

 * *Files identical despite different names*

### Comparing `pyquotegen-0.0.2/setup.py` & `pyquotegen-0.0.4/setup.py`
