# Comparing `tmp/dfeed-0.0.1.tar.gz` & `tmp/dfeed-0.0b1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dfeed-0.0.1.tar", last modified: Fri Apr 14 06:08:50 2023, max compression
+gzip compressed data, was "dfeed-0.0b1.tar", last modified: Tue Apr 11 17:49:32 2023, max compression
```

## Comparing `dfeed-0.0.1.tar` & `dfeed-0.0b1.tar`

### file list

```diff
@@ -1,28 +1,30 @@
-drwxr-xr-x   0 anon      (1000) wheel      (998)        0 2023-04-14 06:08:50.369854 dfeed-0.0.1/
--rw-r--r--   0 anon      (1000) wheel      (998)    34946 2023-04-11 17:54:43.000000 dfeed-0.0.1/LICENSE
--rw-r--r--   0 anon      (1000) wheel      (998)      602 2023-04-14 06:08:50.369854 dfeed-0.0.1/PKG-INFO
--rw-r--r--   0 anon      (1000) wheel      (998)      292 2023-04-14 05:24:00.000000 dfeed-0.0.1/README.md
--rw-r--r--   0 anon      (1000) wheel      (998)      531 2023-04-14 06:07:53.000000 dfeed-0.0.1/pyproject.toml
--rw-r--r--   0 anon      (1000) wheel      (998)       38 2023-04-14 06:08:50.369854 dfeed-0.0.1/setup.cfg
-drwxr-xr-x   0 anon      (1000) wheel      (998)        0 2023-04-14 06:08:50.369854 dfeed-0.0.1/src/
-drwxr-xr-x   0 anon      (1000) wheel      (998)        0 2023-04-14 06:08:50.369854 dfeed-0.0.1/src/dfeed/
--rwxr-xr-x   0 anon      (1000) wheel      (998)       23 2022-09-22 02:48:23.000000 dfeed-0.0.1/src/dfeed/__init__.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     1045 2023-04-13 23:57:25.000000 dfeed-0.0.1/src/dfeed/__main__.py
--rw-r--r--   0 anon      (1000) wheel      (998)     1119 2023-04-14 02:33:41.000000 dfeed-0.0.1/src/dfeed/args.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     1353 2023-04-14 06:01:00.000000 dfeed-0.0.1/src/dfeed/config.py
--rw-r--r--   0 anon      (1000) wheel      (998)     2769 2023-04-14 02:59:37.000000 dfeed-0.0.1/src/dfeed/list_feed.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)      200 2023-04-11 17:46:36.000000 dfeed-0.0.1/src/dfeed/media.py
--rw-r--r--   0 anon      (1000) wheel      (998)     1289 2023-04-13 22:59:40.000000 dfeed-0.0.1/src/dfeed/opener.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     2737 2023-04-14 06:03:08.000000 dfeed-0.0.1/src/dfeed/options.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     1180 2023-04-14 00:34:56.000000 dfeed-0.0.1/src/dfeed/prompts.py
--rw-r--r--   0 anon      (1000) wheel      (998)     9026 2023-04-14 06:07:06.000000 dfeed-0.0.1/src/dfeed/sfeed.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     2412 2023-04-13 22:59:40.000000 dfeed-0.0.1/src/dfeed/system.py
--rw-r--r--   0 anon      (1000) wheel      (998)     1793 2023-04-13 22:59:40.000000 dfeed-0.0.1/src/dfeed/user.py
--rwxr-xr-x   0 anon      (1000) wheel      (998)     4517 2023-04-13 18:56:57.000000 dfeed-0.0.1/src/dfeed/utils.py
-drwxr-xr-x   0 anon      (1000) wheel      (998)        0 2023-04-14 06:08:50.369854 dfeed-0.0.1/src/dfeed.egg-info/
--rw-r--r--   0 anon      (1000) wheel      (998)      602 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/PKG-INFO
--rw-r--r--   0 anon      (1000) wheel      (998)      494 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/SOURCES.txt
--rw-r--r--   0 anon      (1000) wheel      (998)        1 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/dependency_links.txt
--rw-r--r--   0 anon      (1000) wheel      (998)       46 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/entry_points.txt
--rw-r--r--   0 anon      (1000) wheel      (998)       24 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/requires.txt
--rw-r--r--   0 anon      (1000) wheel      (998)        6 2023-04-14 06:08:50.000000 dfeed-0.0.1/src/dfeed.egg-info/top_level.txt
...
### Comparing `dfeed-0.0.1/LICENSE` & `dfeed-0.0b1/LICENSE`
...
### Comparing `dfeed-0.0.1/pyproject.toml` & `dfeed-0.0b1/pyproject.toml`
...
### Comparing `dfeed-0.0.1/src/dfeed/__main__.py` & `dfeed-0.0b1/src/dfeed/__main__.py`
...
### Comparing `dfeed-0.0.1/src/dfeed/prompts.py` & `dfeed-0.0b1/src/dfeed/prompts.py`
...
### Comparing `dfeed-0.0.1/src/dfeed/system.py` & `dfeed-0.0b1/src/dfeed/system.py`
