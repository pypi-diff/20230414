# Comparing `tmp/robit-0.2.3.tar.gz` & `tmp/robit-0.3.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "robit-0.2.3.tar", last modified: Mon Jan 17 20:29:22 2022, max compression
+gzip compressed data, was "robit-0.3.0.tar", last modified: Fri Apr 14 15:04:03 2023, max compression
```

## Comparing `robit-0.2.3.tar` & `robit-0.3.0.tar`

### file list

```diff
@@ -1,56 +1,59 @@
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/
--rw-r--r--   0 runner    (1001) docker     (121)     1073 2022-01-17 20:29:13.000000 robit-0.2.3/LICENSE.txt
--rw-r--r--   0 runner    (1001) docker     (121)       20 2022-01-17 20:29:13.000000 robit-0.2.3/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (121)     2696 2022-01-17 20:29:22.203507 robit-0.2.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)     2233 2022-01-17 20:29:13.000000 robit-0.2.3/README.md
--rw-r--r--   0 runner    (1001) docker     (121)      103 2022-01-17 20:29:13.000000 robit-0.2.3/pyproject.toml
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.199506 robit-0.2.3/robit/
--rw-r--r--   0 runner    (1001) docker     (121)      183 2022-01-17 20:29:13.000000 robit-0.2.3/robit/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/core/
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)     1587 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/alert.py
--rw-r--r--   0 runner    (1001) docker     (121)       48 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/base.py
--rw-r--r--   0 runner    (1001) docker     (121)      840 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/clock.py
--rw-r--r--   0 runner    (1001) docker     (121)      282 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/counter.py
--rw-r--r--   0 runner    (1001) docker     (121)     6750 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/cron.py
--rw-r--r--   0 runner    (1001) docker     (121)     1919 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/health.py
--rw-r--r--   0 runner    (1001) docker     (121)      193 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/id.py
--rw-r--r--   0 runner    (1001) docker     (121)      646 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/log.py
--rw-r--r--   0 runner    (1001) docker     (121)      176 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/name.py
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/notification.py
--rw-r--r--   0 runner    (1001) docker     (121)      700 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/status.py
--rw-r--r--   0 runner    (1001) docker     (121)     1891 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/timer.py
--rw-r--r--   0 runner    (1001) docker     (121)      366 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/web_client.py
--rw-r--r--   0 runner    (1001) docker     (121)     2976 2022-01-17 20:29:13.000000 robit-0.2.3/robit/core/web_server.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/html/
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)   155841 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/bootstrap.css
--rw-r--r--   0 runner    (1001) docker     (121)    78732 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/bootstrap.js
--rw-r--r--   0 runner    (1001) docker     (121)     1050 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/index.css
--rw-r--r--   0 runner    (1001) docker     (121)      791 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/monitor.js
--rw-r--r--   0 runner    (1001) docker     (121)     2751 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/monitor_index.html
--rw-r--r--   0 runner    (1001) docker     (121)    17142 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/petite_vue.js
--rw-r--r--   0 runner    (1001) docker     (121)     1339 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/worker.js
--rw-r--r--   0 runner    (1001) docker     (121)    11178 2022-01-17 20:29:13.000000 robit-0.2.3/robit/html/worker_index.html
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/job/
--rw-r--r--   0 runner    (1001) docker     (121)       63 2022-01-17 20:29:13.000000 robit-0.2.3/robit/job/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)     2144 2022-01-17 20:29:13.000000 robit-0.2.3/robit/job/group.py
--rw-r--r--   0 runner    (1001) docker     (121)     3785 2022-01-17 20:29:13.000000 robit-0.2.3/robit/job/job.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/monitor/
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/monitor/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)     2439 2022-01-17 20:29:13.000000 robit-0.2.3/robit/monitor/monitor.py
--rw-r--r--   0 runner    (1001) docker     (121)     1533 2022-01-17 20:29:13.000000 robit-0.2.3/robit/monitor/web_server.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/test/
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/test/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)      434 2022-01-17 20:29:13.000000 robit-0.2.3/robit/test/test_robit.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.203507 robit-0.2.3/robit/worker/
--rw-r--r--   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:13.000000 robit-0.2.3/robit/worker/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)     2049 2022-01-17 20:29:13.000000 robit-0.2.3/robit/worker/web_server.py
--rw-r--r--   0 runner    (1001) docker     (121)     3795 2022-01-17 20:29:13.000000 robit-0.2.3/robit/worker/worker.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2022-01-17 20:29:22.199506 robit-0.2.3/robit.egg-info/
--rw-r--r--   0 runner    (1001) docker     (121)     2696 2022-01-17 20:29:22.000000 robit-0.2.3/robit.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)      997 2022-01-17 20:29:22.000000 robit-0.2.3/robit.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (121)        1 2022-01-17 20:29:22.000000 robit-0.2.3/robit.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (121)        6 2022-01-17 20:29:22.000000 robit-0.2.3/robit.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (121)      511 2022-01-17 20:29:22.203507 robit-0.2.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (121)       37 2022-01-17 20:29:13.000000 robit-0.2.3/setup.py
...
### Comparing `robit-0.2.3/LICENSE.txt` & `robit-0.3.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/PKG-INFO` & `robit-0.3.0/PKG-INFO`
...
### Comparing `robit-0.2.3/README.md` & `robit-0.3.0/README.md`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/robit/core/clock.py` & `robit-0.3.0/robit/core/clock.py`
...
### Comparing `robit-0.2.3/robit/core/health.py` & `robit-0.3.0/robit/core/health.py`
...
### Comparing `robit-0.2.3/robit/core/log.py` & `robit-0.3.0/robit/core/log.py`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/robit/core/status.py` & `robit-0.3.0/robit/core/status.py`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/robit/core/timer.py` & `robit-0.3.0/robit/core/timer.py`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/robit/core/web_server.py` & `robit-0.3.0/robit/core/web_server.py`
...
### Comparing `robit-0.2.3/robit/html/bootstrap.css` & `robit-0.3.0/robit/html/bootstrap.css`
...
### Comparing `robit-0.2.3/robit/html/bootstrap.js` & `robit-0.3.0/robit/html/bootstrap.js`
...
### Comparing `robit-0.2.3/robit/html/index.css` & `robit-0.3.0/robit/html/index.css`

 * *Files identical despite different names*

### Comparing `robit-0.2.3/robit/html/monitor_index.html` & `robit-0.3.0/robit/html/monitor.html`
...
-<div v-scope="Container()" class="container-fluid pb-3" @mounted="start">
...
-                <span class="h5 text-light">{{ data.name }}</span>
...
-                <span class="h5 text-light">{{ data.clock.now }}</span>
...
-                <span class="h5 text-light">{{ data.health }}%</span>
+                <span class="h5 text-light" x-text="data.health"></span>
             </div>
         </div>
 
-        <div v-if="data.workers.length > 0" class="row">
-            <div v-for="(worker, i) in data.workers" :key="i" class="col-12">
-                <div class="row px-2 px-md-3 pt-3">
-                    <div class="col-12 bg-worker-layer shadow-sm rounded-3 p-3">
-
-                        <div class="row">
-                            <div class="col-7 col-md-10">
-                                <span class="fs-7 text-monitor-muted">Worker {{ worker.clock.now }}</span><br/>
-                                <span class="h5">{{ worker.name }}</span>
-                            </div>
-                            <div class="col-5 col-md-2 text-end">
-                                <span class="fs-7 text-monitor-muted">Health</span><br/>
-                                <span class="h5">{{ worker.health }}%</span>
...
-<script type="application/javascript" src="petite_vue.js"></script>
...
### Comparing `robit-0.2.3/robit/html/worker_index.html` & `robit-0.3.0/robit/html/worker.html`
...
+
     <div id="container" class="d-none">
         <div class="row sticky-top bg-worker-nav shadow-sm">
             <div class="col-6 col-md-4 px-3 py-2">
                 <span class="h7 text-light-muted">Worker</span><br/>
-                <span class="h5 text-light">{{ data.name }}</span>
+                <span class="h5 text-light" x-text="data.name"></span>
             </div>
             <div class="col-6 col-md-4 px-3 py-2 text-end text-md-center">
...
-        <div v-if="data.groups.length > 0" class="row">
-            <div v-for="(group, i) in data.groups" :key="i" class="col-12">
+        <template x-if="data.groups.length > 0">
 
-                <div class="row px-2 px-md-3 pt-3">
-                    <div class="col-12 bg-group-layer shadow-sm rounded-3 p-3">
+            <div class="row">
...
-                                <span class="h5">{{ group.health }}%</span>
-                            </div>
-                        </div>
+                <template x-for="(group, i) in data.groups">
 
-                        <div v-if="group.jobs.length > 0" class="row">
-                            <div v-for="(job, i) in group.jobs" :key="i" class="col-12 px-3 pb-2">
+                    <div :key="i" class="col-12">
 
-                                <div v-on:click="get_job_details(job.id)" class="row px-2 px-md-3 pt-2">
...
-                                                        class="text-muted fw-normal">next run at {{ job.next_run_datetime }}</span></span>
-                                                <br/>
-                                                <span class="h6">{{ job.name }}</span>
-                                            </div>
-                                            <div class="col-6 col-sm-2 text-center pb-2 pb-sm-0">
-                                                <span class="fs-7 text-worker-muted">Status</span><br/>
-                                                <span v-if="job.status == 'Running'" class="h6 text-status-running">{{ job.status }}</span>
-                                                <span v-else-if="job.status == 'Error'" class="h6 text-status-error">{{ job.status }}</span>
-                                                <span v-else class="h6 text-status-waiting">{{ job.status }}</span>
-                                            </div>
-                                            <div class="col-6 text-center pb-2 pb-sm-0 d-block d-sm-none">
-                                                <span class="fs-7 text-worker-muted">Health</span><br/>
-                                                <span class="h6">{{ job.health }}%</span>
-                                            </div>
-                                            <div class="col-6 col-sm-2 text-center">
-                                                <span class="fs-7 text-worker-muted">Success</span><br/>
-                                                <span class="h6">{{ job.success_count }}</span>
-                                            </div>
-                                            <div class="col-6 col-sm-2 text-center">
-                                                <span class="fs-7 text-worker-muted">Failed</span><br/>
-                                                <span class="h6">{{ job.failed_count }}</span>
-                                            </div>
...
-                                            <div v-if="job_details[job.id]" class="col">
+                                <div class="row pb-2">
+                                    <div class="col-7 col-md-10">
+                                        <span class="fs-7 text-worker-muted fw-bold">Group</span><br/>
...
-                                                        <span class="fs-7 ps-2">{{ job_details[job.id].method }}</span>
-                                                    </div>
-                                                    <div class="col-6 col-sm-2 text-center pb-2 pb-sm-0">
-                                                        <span class="fs-7 text-worker-muted">Average Runtime</span><br/>
-                                                        <span class="h6">{{ job_details[job.id].timer.average_duration }}sec</span>
-                                                    </div>
-                                                    <div class="col-6 col-sm-2 text-center pb-2 pb-sm-0">
-                                                        <span class="fs-7 text-worker-muted">Last Runtime</span><br/>
-                                                        <span class="h6">{{ job_details[job.id].timer.last_duration }}sec</span>
-                                                    </div>
-                                                    <div class="col-6 col-sm-2 text-center">
-                                                        <span class="fs-7 text-worker-muted">Shortest Runtime</span><br/>
-                                                        <span class="h6">{{ job_details[job.id].timer.shortest_duration }}sec</span>
-                                                    </div>
-                                                    <div class="col-6 col-sm-2 text-center">
-                                                        <span class="fs-7 text-worker-muted">Longest Runtime</span><br/>
-                                                        <span class="h6">{{ job_details[job.id].timer.longest_duration }}sec</span>
-                                                    </div>
-                                                    <div class="col-12 d-block d-sm-none pt-2">
-                                                        <span class="fs-7 text-worker-muted">Method</span><br/>
-                                                        <span class="h6">{{ job_details[job.id].method }}</span>
-                                                    </div>
-                                                </div>
+                                    <div class="row">
 
-                                                <div v-if="job_details[job.id].failed_log.length > 0" class="row mb-1">
-                                                    <div class="col-12">
...
-                                                <div v-if="job_details[job.id].failed_log.length > 0"
-                                                     class="row mb-1 me-1 overflow-auto" style="max-height: 300px;">
-                                                    <div v-for="(message, i) in job_details[job.id].failed_log" :key="i"
-                                                         class="col-12 px-4">
-                                                        <li class="fs-7 text-muted">{{ message }}</li>
-                                                    </div>
-                                                </div>
+                                            <div :key="i" class="col-12 px-3 pb-2">
 
-                                                <div v-if="job_details[job.id].result_log.length > 0" class="row mb-1">
-                                                    <div class="col-12">
...
-                                                <div v-if="job_details[job.id].result_log.length > 0"
-                                                     class="row mb-1 me-1 overflow-auto" style="max-height: 300px;">
-                                                    <div v-for="(message, i) in job_details[job.id].result_log" :key="i"
-                                                         class="col-12 px-4">
-                                                        <li class="fs-7 text-muted">{{ message }}</li>
                                                     </div>
                                                 </div>
...
-Job next run at {{ job.next_run_datetime }}
-{{ job.name }}
+Job
 Status
...
-{{ job.health }}%
 ...
 ===============================================================================
 Method
-{{ job_details[job.id].method }}
 Average Runtime
-{{ job_details[job.id].timer.average_duration }}sec
 Last Runtime
-{{ job_details[job.id].timer.last_duration }}sec
 Shortest Runtime
-{{ job_details[job.id].timer.shortest_duration }}sec
 Longest Runtime
-{{ job_details[job.id].timer.longest_duration }}sec
 Method
-{{ job_details[job.id].method }}
 Exceptions
+
 key="i" class="col-12 px-4">
-{{ message }}
 Results
+
 key="i" class="col-12 px-4">
...
### Comparing `robit-0.2.3/robit/job/group.py` & `robit-0.3.0/robit/monitor/monitor.py`
...
### Comparing `robit-0.2.3/robit/job/job.py` & `robit-0.3.0/robit/job/job.py`
...
### Comparing `robit-0.2.3/robit/monitor/monitor.py` & `robit-0.3.0/robit/job/group.py`
...
### Comparing `robit-0.2.3/robit/monitor/web_server.py` & `robit-0.3.0/robit/monitor/web_server.py`
...
### Comparing `robit-0.2.3/robit/worker/web_server.py` & `robit-0.3.0/robit/worker/web_server.py`
...
### Comparing `robit-0.2.3/robit/worker/worker.py` & `robit-0.3.0/robit/worker/worker.py`
...
### Comparing `robit-0.2.3/robit.egg-info/PKG-INFO` & `robit-0.3.0/robit.egg-info/PKG-INFO`
...
### Comparing `robit-0.2.3/robit.egg-info/SOURCES.txt` & `robit-0.3.0/robit.egg-info/SOURCES.txt`
...
+robit/html/monitor.html
 robit/html/monitor.js
