# Comparing `tmp/StaticVar-0.0.2.tar.gz` & `tmp/StaticVar-0.0.4.tar.gz`
...
## Comparing `StaticVar-0.0.2.tar` & `StaticVar-0.0.4.tar`
...
### Comparing `StaticVar-0.0.2/setup.py` & `StaticVar-0.0.4/setup.py`
